...
export default function Navbar({ locale, dict }: NavbarProps) {
  ...
  return (
    <>
      ...
      <header className=" top-0 z-60 w-full">
              ...
              >
                ...
                <span className="sm:hidden">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
                    <path d="M3.75 6.75H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M3.75 12H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                    <path d="M3.75 17.25H20.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                </span>
              </button>
            )}
      ...
      {open && (
        <div className="bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            {/* Left Image Section */}
            <div className="hidden md:flex flex-col justify-between p-8 border-r border-border-stroke">
              <Image
