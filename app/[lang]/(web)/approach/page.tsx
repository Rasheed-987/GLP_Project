    ...
    return (
        <>
            ...
            <section className="pb-12 md:pb-28">
                <Container className="px-4">
                    <div className="bg-[#E6EFEA] rounded-[1.5rem] p-2 md:p-4 lg:p-8">
                        <div className="flex flex-col lg:flex-row gap-2 lg:gap-4 mb-16 items-start">
                            {/* Left Side: Title */}
                            <div className="w-full lg:w-3/4 ">
                                <h2 className="text-2xl max-w-2xl md:text-[1.75rem] leading-[1.2] font-medium bg-gradient-to-r from-[#045A86] to-[#019977] bg-clip-text text-transparent">
            ...
            <section className="pb-8 md:pb-16">
                <Container className="px-4">
                    <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                        {/* Label */}
                        <span className="text-brand-from text-sm md:text-[16px] font-semibold uppercase tracking-[1.6] mb-2">
                            {dict.approach.learningMethodology.label}
                        </span>

                        {/* Separator Line */}
                        <div className="w-28 h-1 bg-[#045A8633] rounded-full overflow-hidden mb-8 md:mb-12">
                            <div className="h-full w-1/2 bg-[#045A86] rounded-full"></div>
                        </div>


                        {/* Title - Gradient applied to whole block */}
                        <h2 className="text-2xl md:text-[2.5rem] leading-[0.8] mb-7 bg-gradient-to-r from-[#045A86] to-[#019977] bg-clip-text text-transparent">
                        ...
                        {/* Description */}
                        <p className="text-[#00000099] text-base md:text-[16px] leading-[1.2] max-w-2xl">
            ...
            <section className="pb-12 md:pb-24">
                <Container className="px-4">
                    <div className="flex flex-col lg:flex-row gap-8  lg:gap-20 items-center">
                        {/* Left Column: Content */}
                        <div className="w-full ps-16 lg:w-6/12  ">
                            <h3 className="text-[#045A86] font-bold text-sm md:text-base uppercase mb-8 tracking-[1.2]">
                                ...
                                {dict.approach.learningMethodologyPart2.items.map((item, idx) => {
                                    ...
                                    return (
                                        <li key={idx} className="flex items-center gap-3">
                                            ...
                                            <span className="text-[#00000099] text-base md:text-[16px] leading-[1.2]">
                                                {item}
                                            </span>
                                        </li>
                                    );
                        ...
                        <div className="w-full lg:w-6/12">
                            <div className="relative w-full h-full min-h-[600px] rounded-[1.5rem] overflow-hidden">
                                <Image
            ...
            <section className="pb-4 md:pb-8">
                <Container className="px-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-32 mb-16">
                        {/* Left Column: Label, Line, Title */}
                        <div className="w-full lg:w-1/2">
                            {/* Label */}
                            <span className="text-brand-from text-sm md:text-[15px] font-semibold uppercase tracking-[1.6] mb-4 block">
                                {dict.approach.aboutUAELGM.label}
                            </span>

                            {/* Separator Line */}
                            <div className="w-20 h-0.5 bg-[#045A8633] rounded-full overflow-hidden mb-8">
                                <div className="h-full w-1/2 bg-[#045A86] rounded-full"></div>
                            </div>

                            {/* Title with Gradient */}
                            <h2 className="text-2xl md:text-[1.55rem] leading-[1.1]    bg-gradient-to-r from-[#045A86] to-[#019977] bg-clip-text text-transparent">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col ps-32 justify-start pt-18 gap-6">
                            <p className="text-[#00000099] text-base md:text-[16px] leading-[1.2]">
                    ...
                    <div className="border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3">
                            {dict.approach.aboutUAELGM.pillars.map((pillar, idx) => (
                                <div
                                    key={idx}
                                    className={`bg-white p-5 text-center ${idx !== 2 ? 'md:border-r border-gray-200' : ''}`}
                                >
                                    <h4
            ...
            <section className="relative py-8 overflow-hidden mt-40">
                {/* Background Image */}
                ...
                <Container className="relative z-10 px-4">
                    <div className="bg-white rounded-[1.5rem] p-4 md:p-6 lg:p-8">
                        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-start">
                            {/* Left Column: Image */}
                            <div className="w-full lg:w-1/2">
                                <div className="relative aspect-[4/3] w-full min-h-[600px] rounded-[1.5rem] overflow-hidden">
                                    <Image
                            ...
                            <div className="w-full lg:w-1/2">
                                ...
                                {/* Separator Line */}
                                <div className="w-24 h-1 bg-[#045A8633] rounded-full overflow-hidden mb-5">
                                    <div className="h-full w-1/2 bg-[#045A86] rounded-full"></div>
                                </div>

                                {/* Title with Gradient */}
                                <h2 className="text-2xl max-w-sm md:text-[1.75rem] leading-[1.2] mb-6 bg-gradient-to-r from-[#045A86] to-[#019977] bg-clip-text text-transparent">
                                ...
                                {/* Description */}
                                <p className="text-[#00000099] text-base md:text-[16px] leading-[1.2] mb-44">
                                    {dict.approach.alumniNetwork.description}
                                </p>

                                {/* Benefits Title */}
                                <h3 className="text-brand-from font-bold text-sm md:text-[15px] uppercase tracking-[1.2] mb-4">
                                    ...
                                    {dict.approach.alumniNetwork.benefits.map((benefit, idx) => {
                                        ...
                                        return (
                                            <li key={idx} className="flex items-start gap-3">
                                                ...
                                                <span className="text-[#00000099] text-sm md:text-[15px] leading-[1.2]">
                                                    {benefit}
                                                </span>
                                            </li>
                                        );
