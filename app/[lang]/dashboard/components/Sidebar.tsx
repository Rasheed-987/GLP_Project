        ...
        <aside className={`w-64 h-screen bg-[#F7FAF9] border-r border-border-stroke flex flex-col fixed top-0 z-50 transition-all duration-300 ${lang === 'ar' ? 'right-0 border-l border-r-0' : 'left-0 border-r border-l-0'}`}>
            ...
            <div className="p-4 border-t border-border-stroke">
                <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-semibold text-[#00000099] hover:bg-red-50 hover:text-red-600 transition-all disabled:opacity-50"
                >
                    {isLoggingOut ? (
